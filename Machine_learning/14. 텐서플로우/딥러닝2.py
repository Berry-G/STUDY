'''
    1. Intelligence(지능)
        ...
        4) 컴퓨터가 스스로 방법을 찾아냄 : 데이터를 기반으로 스스로 학습할 수 있음
            - 알파고 : 컴퓨터에 바둑 경기의 규칙과 이전 경기의 많은 데이터를 알려줌
                        ==> 컴퓨터가 스스로 바둑의 원리를 학습하여 바둑을 둘 수 있었던 것
        5)              <파라미터 수정>               <평가>
                              ↓                       ↑
    ...
    3. 머신러닝 종류
        1) 지도학습 (supervised learning)
            ...
            - 예 ) 고양이, 개를 구분할 때 고양이인지 개인지 라벨링된 데이터를 충분히 제공한 뒤에 학습하도록 하는 과정 필요
                - 학습 단계 => 예측 모델 => 테스트 단계
        2) 비지도학습 (unsupervised learning)
            - 정답(라벨)을 주지 않고 학습 알고리즘이 스스로 어떤 구조를 발견하는 학습
    ...
    4. 회귀분석
        ...
        2) 회귀분석
            - 대표적인 지도학습 알고리즘
            - 데이터(독립변수)를 통해 종속변수 사이의 숨어있는 관계를 추정하는 것
